...
const PREFIXES = { annotator: 'mda:', forge: 'forge:', bookmarks: 'bm:', feed: 'feed:', reading: 'rl:', default: 'mda:' };
  ...
  try {
    ...
    if (req.method === 'PUT') {
      ...
      if (app === 'bookmarks') {
        ...
        payload.topicsFr = body.topicsFr || [];
        payload.topicsEn = body.topicsEn || [];
        payload.presets = body.presets || [];
      } else if (app === 'forge') {
